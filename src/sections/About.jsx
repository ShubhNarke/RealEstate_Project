...
const About = () => {
  ...
  return (
    <section
      ...
      } w-full m-auto lg:px40 px-10 py-20 grid lg:grid-cols-2 grid-cols-1 justify-center items-center gap-10`}
    >
      <div>
        <img
          data-aos="zoom-in"
      ...
      <div className="flex flex-col justify-center items-start gap-8 ">
        ...
        >
          ...
          quasi nostrum consectetur nam odit error quae repellat quo rerum
          facilis, vitae fugit reiciendis libero?
        </p>
